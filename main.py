...
app = capitalcrud.create_app(config)


# [START capitals_queue]
# Make the queue available at the top-level, this allows you to run
# `psqworker main.capitals_queue`. We have to use the app's context because
...
with app.app_context():
    print( "create queue")
    capitals_queue = capitalcrud.tasks.get_capitals_queue()
    print ("done")
# [END capitals_queue]
